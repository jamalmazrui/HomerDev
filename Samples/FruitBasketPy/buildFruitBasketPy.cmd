...
set "homerDev="
if defined HomerDev if exist "%HomerDev%\Python\homer\lbc.py" set "homerDev=%HomerDev%"
if not defined homerDev if exist "C:\HomerDev\Python\homer\lbc.py" set "homerDev=C:\HomerDev"
if not defined homerDev if exist "%CD%\Python\homer\lbc.py" set "homerDev=%CD%"
